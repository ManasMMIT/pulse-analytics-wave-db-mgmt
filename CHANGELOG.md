...
- `Orion/Perception Tool`:
  ...
  - Categories / Characteristics Tab: sorting and materialization [#1088](https://github.com/pulse-analytics/wave-db-mgmt/pull/1088)
  - View & Materialization: Client Team Market Basket Subscriptions [#1097](https://github.com/pulse-analytics/wave-db-mgmt/pull/1097)
...
- `Perception Tool/Vega Migration`: Added vega ops to necessary mongo CUD
  ...
  - Regimen CUD [#930](https://github.com/pulse-analytics/wave-db-mgmt/pull/930)
  - Product CUD [#931](https://github.com/pulse-analytics/wave-db-mgmt/pull/931)

### Fixed
- `Delphi`: Replaced `react-tabular` use in Delphi and removed the library all together, as it was causing breakage in production. [#933](https://github.com/pulse-analytics/wave-db-mgmt/pull/933)
...
### Changed
- `Orion`: Switched CRUD relevant to dev pathways influencers to real collection instead of TEMP [#904](https://github.com/pulse-analytics/wave-db-mgmt/pull/904)
