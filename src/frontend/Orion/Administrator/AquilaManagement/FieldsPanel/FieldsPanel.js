...
const FieldsPanel = () => {
  ...
  const { aquilaConfigId: selectedAquilaConfigId, fieldId: selectedFieldId } =
  ...
  const selectedAquilaConfig = data.aquilaConfigs.find(
    ({ _id }) => _id === selectedAquilaConfigId
  )
          ...
          {fields.map((fieldObj) => (
            ...
            >
              <DeleteButton
                ...
                afterMutationHook={() => {
                  const nextFieldSelection = fields.find(
