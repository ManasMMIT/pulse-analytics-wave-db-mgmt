          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                label: 'Duped Overview Field (should update in line with field above)',
                key: 'overview',
                inputComponent: 'TextInput',
                inputProps: {
                  type: 'string',
            ...
            fields: [
              ...
              },
              {
                ...
                inputProps: {
                  type: 'date',
                  options: [
                    { label: new Date(2018, 0, 3), value: new Date(2018, 0, 3) },
                    { label: new Date(2018, 2, 3), value: new Date(2018, 2, 3) },
                    { label: new Date(2019, 5, 3), value: new Date(2019, 5, 3) },
                    { label: new Date(2020, 2, 20), value: new Date(2020, 2, 20) },
                  ],
                },
              },
              {
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                label: 'Locked String Field (cuz options is empty array instead of null)',
                key: 'fakeLockedField',
                inputComponent: 'Select',
                inputProps: {
                  type: 'string',
