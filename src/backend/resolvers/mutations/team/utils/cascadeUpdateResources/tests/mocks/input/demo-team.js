const payerToolNodeResourcesObj = require('./prev-resources')

module.exports = {
  _id: '25903626-b6c1-49fe-8155-b06787ab0dbb',
  name: 'demo',
  description: 'Demo',
  client: {
    _id: '3858532e-52a1-44f9-81c6-7c1486aa4168',
    name: 'Engineering',
  ...
  sitemap: {
    ...
    pages: [
      ...
      {
        _id: 'f0e7281a-1ce5-4eae-8e8a-b8b8323622ee',
        name: 'Treatment Centers',
        type: 'page',
        componentPath: './CustomClientPages/Novartis/TreatmentCenters',
        text: {
          subtitle: null,
          caption: null,
      ...
      {
        _id: 'dd7d0054-de27-415b-96e1-1150a88c6d84',
        name: 'Dupixent Relative Access',
        type: 'page',
        componentPath: './CustomClientPages/Regeneron/DupixentRelativeAccess',
        text: {
          subtitle: null,
          caption: null,
          title: 'Dupixent Relative Access',
        },
        order: 3,
        parentId: 'db5a25db-a2c2-4da5-8bf7-c80e42cc13f7',
        schemaVersion: 'v1.0.0',
    ...
    cards: [
      {
        ...
        text: {
          subtitle:
            'List of valued data & education resources for account decision-making',
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Outline of account-level manufacturer engagement restrictions & preferences',
          caption: null,
          title: 'Manufacturer Engagement',
        },
        subtitle:
      ...
      },
      {
        ...
        text: {
          subtitle:
            'List of key individuals with the greatest impact on account decision making',
      ...
      },
      {
        ...
        text: {
          subtitle:
            'https://s3-us-west-2.amazonaws.com/tdgwebportal/Lilly+Key+Accounts/Web+Tool+Tutorial+-+Lilly+Key+Accounts+2019.pdf',
          caption:
            'Walk-through of tool capabilities and functionality across the management and account dashboard views.',
          title: 'Tutorial',
        },
        subtitle:
          'https://s3-us-west-2.amazonaws.com/tdgwebportal/Lilly+Key+Accounts/Web+Tool+Tutorial+-+Lilly+Key+Accounts+2019.pdf',
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Summary of account participation in value-based care programs (e.g. OCM, national & regional Alternative Payment Models). Select account to view profile.',
          caption: null,
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Annual Medicare patient volume based on diagnosis code records',
          caption:
            'Note: sourced from Medicare claims data from 2017 Medicare SAF (1/1/2017 - 12/31/2017) via ICD‌-9 codes; not mutually exclusive',
      ...
      },
      {
        ...
        text: {
          ...
          caption:
            'Note: Payer mix based on % of total charges; top 3 payers listed by percent of total claims volume from Medicare report financials; Commercial & Self - Pay reported in aggregate',
          title: 'Payer Mix',
        },
        subtitle: 'Based on Medicare cost report financials & claims data',
        caption:
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Overview of account sophistication by EMR, procurement & pharmacy capabilities',
          caption: null,
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Outline of key market events & innovative account partnerships',
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Summary of account participation in 3rd party or internal pathways',
          caption: null,
          title: 'Pathways',
        },
        subtitle:
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Breakdown of 3rd party pathways vendors & participating accounts',
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Level of pathways integration across all account sites & EMR',
          caption: null,
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Strategies utilized in order to enforce adherence to internal pathways',
          caption: null,
      ...
      {
        _id: 'c6d15dbf-4239-420d-8a56-72c444a3550c',
        name: 'Precision Medicine',
        type: 'card',
        componentPath: './PrecisionMedicine',
        text: {
          subtitle: 'Overview of account biomarker testing capabilities',
          caption: null,
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Overview of accounts that have internal dispensing & support capabilities for specialty therapeutics',
          caption: null,
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Whether accounts have key pharmacy accreditations, indicating dispensing sophistication',
          caption: null,
      ...
      },
      {
        ...
        text: {
          subtitle:
            'Pathways positioning of key brands vs. competitors for priority indications',
      ...
      },
      {
        ...
        text: {
          ...
          caption:
            'Physicians by primary specialty (based on staff with primary affiliation to account hospitals / affiliated locations)',
          title: 'Staffing',
        },
        subtitle: 'Oncologist & supportive care staffing',
        caption:
      ...
      },
      {
        ...
        text: {
          subtitle: null,
          caption:
            'Discover trends across the entire account sample through aggregate views of the site of care mix, pharmacy capabilities, pathways, and alternative payment models.',
      ...
      },
      {
        ...
        text: {
          subtitle: null,
          caption:
            'In-depth account profiles detailing important operational infrastructure, clinical sophistication, cost and economic priorities, as well as key decision makers to engage.',
  ...
  users: [
    {
      _id: 'auth0|demo@example.com',
      username: 'demo@example.com',
      email: 'demo@example.com',
    },
  ],
  schemaVersion: 'v1.0.0',
  resources: [payerToolNodeResourcesObj],
}
