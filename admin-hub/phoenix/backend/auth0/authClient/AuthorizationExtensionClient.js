...
module.exports = class {
  ...
  updateRole({ id, name, description, permissions }) {
    return this.authenticate()
      .then(() =>
        fetch(`https://pulse-digital.us8.webtask.io/adf6e2f2b84784b57522e3b19dfc9201/api/roles/${ id }`, {
          method: 'PUT',
          headers: {
            authorization: `Bearer ${this.accessToken}`,
            'Content-Type': 'application/json'
  ...
  removeNestedGroup(clientId, teamId) {
    return this.authenticate()
      .then(() =>
        fetch(`https://pulse-digital.us8.webtask.io/adf6e2f2b84784b57522e3b19dfc9201/api/groups/${clientId}/nested`, {
          method: 'DELETE',
          headers: {
            authorization: `Bearer ${this.accessToken}`,
            'Content-Type': 'application/json'
  ...
  removeGroup(groupId) {
    return this.authenticate()
      .then(() =>
        fetch(`https://pulse-digital.us8.webtask.io/adf6e2f2b84784b57522e3b19dfc9201/api/groups/${groupId}`, {
          method: 'DELETE',
          headers: {
            authorization: `Bearer ${this.accessToken}`,
            'Content-Type': 'application/json'
  ...
  removeRole(roleId) {
    return this.authenticate()
      .then(() =>
        fetch(`https://pulse-digital.us8.webtask.io/adf6e2f2b84784b57522e3b19dfc9201/api/roles/${roleId}`, {
          method: 'DELETE',
          headers: {
            authorization: `Bearer ${this.accessToken}`,
            'Content-Type': 'application/json'
  ...
  removeGroupMembers(groupId, userIdArray) {
    return this.authenticate().then(() =>
      fetch(`https://pulse-digital.us8.webtask.io/adf6e2f2b84784b57522e3b19dfc9201/api/groups/${groupId}/members`, {
        method: 'DELETE',
        headers: {
          authorization: `Bearer ${this.accessToken}`,
          'content-type': 'application/json'
